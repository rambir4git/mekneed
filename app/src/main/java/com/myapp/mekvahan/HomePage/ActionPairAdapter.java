...
public class ActionPairAdapter extends RecyclerView.Adapter<ActionPairAdapter.MyViewHolder> {

    private Context context;
    private List<Pair<String,String>> mActionPairList;

    public ActionPairAdapter(Context context, List<Pair<String, String>> mActionPairList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.itemaction.setText("(" + pair.second + ")");
